#!/usr/bin/env bash
# Regenerate fixtures/reference.vcd (and optionally reference.fst).
#
# Requires: iverilog + vvp on PATH. vcd2fst is optional.
...
iverilog -g2012 -o build/sim.vvp tb/tb_counter.v src/counter.v
vvp build/sim.vvp
